...
a picture of myself using the img tag, my school year, and my major, all in plain text. I then included links that would redirect to the other two routes that I created. F
inally, I added a hyperlink to my favorite news source. The classes page lists the classes that I took this semester, and then a few sentences detailing my favorite class in 
...
The pictures I included in the homepage and the states page were stored in a static folder under a subfolder images, and route was used in the html files. The html files
were stored in a separate folder called templates and includes the html for the homepage, classes page, and states page. 
